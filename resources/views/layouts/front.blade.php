...
<body>
    ...
    <header data-bs-theme="dark">
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('home-front') }}">متجر الكتروني</a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ route('home-front') }}">الرئيسية</a>
                        </li>
                    </ul>
    ...
    <footer class="container text-center py-3">
        <p class="mb-1">
            &copy; 2025 <strong>Mohammed AbuSaada</strong> | جميع الحقوق محفوظة
        </p>
        <p class="mb-1">
            <a href="#">عد إلى الأعلى</a> &middot;
            <a href="#">سياسة الخصوصية</a> &middot;
            <a href="#">شروط الاستخدام</a>
        </p>
        <p>
            حسابي على
            <a href="https://github.com/mohammedabusaada" target="_blank" rel="noopener noreferrer">
                GitHub
            </a>
        </p>
    </footer>
